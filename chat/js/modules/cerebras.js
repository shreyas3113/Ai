...
class CerebrasAPI {
        ...
        for (const endpoint of endpoints) {
            try {
                ...
                const requestPayload = {
                    ...
                    model: 'llama-4-scout-17b-16e-instruct', // Or 'gpt-oss-120b' if available and desired
                    stream: false,
    ...
    async generateResponse(prompt, options = {}) {
        try {
            ...
            const modelName = options.model || 'llama-4-scout-17b-16e-instruct'; // Default to llama-4-scout-17b-16e-instruct, but allow gpt-oss-120b
